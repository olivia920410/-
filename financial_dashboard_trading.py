...
try:
    ...
    st.stop() # 如果日期格式錯誤，則停止應用程式執行

# 將轉換後的 datetime 物件賦值給 `start_date` 和 `end_date`
