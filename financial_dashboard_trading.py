...
if choice_strategy == choices_strategies[1]:
    ...
    ChartOrder_RSI(KBar_df, OrderRecord.GetTradeRecord())  # 臨時使用MA的繪圖函數
...
if choice_strategy == choices_strategies[2]:
    ...
    ChartOrder_Bollinger(KBar_df, OrderRecord.GetTradeRecord()) # ChartOrder_MA 已更新可繪製布林通道
...
if choice ==choices[0]  :  ##'中鋼期貨: 2023.4.17 至 2025.4.17'
    OrderRecord.GeneratorProfitChart(choice='future0',StrategyName='RSI')
if choice ==choices[1]  : ##'聯電期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future1',StrategyName='RSI')
if choice == choices[2]  :##'台積電期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future2',StrategyName='RSI')
if choice ==choices[3]  : ##'富邦金期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future3',StrategyName='RSI')
if choice ==choices[4]  : ##'台新金期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future4',StrategyName='RSI')
if choice ==choices[5]  : ##'統一期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future5',StrategyName='RSI')
if choice ==choices[6]  : ##'金融期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future6',StrategyName='RSI')
if choice ==choices[7]  : ##'小型臺指期: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future7',StrategyName='RSI')
if choice ==choices[8]  : ##'臺股期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future8',StrategyName='RSI')
if choice ==choices[9]  : ##'元大台灣50: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='RSI')
if choice ==choices[10]  :## '元大台灣50正2: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='RSI')
if choice ==choices[11]  : ##'台積電: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='RSI')
...
if choice ==choices[0]  :  ##'中鋼期貨: 2023.4.17 至 2025.4.17'
    OrderRecord.GeneratorProfitChart(choice='future0',StrategyName='Bollinger')
if choice ==choices[1]  : ##'聯電期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future1',StrategyName='Bollinger')
if choice == choices[2]  :##'台積電期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future2',StrategyName='Bollinger')
if choice ==choices[3]  : ##'富邦金期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future3',StrategyName='Bollinger')
if choice ==choices[4]  : ##'台新金期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future4',StrategyName='Bollinger')
if choice ==choices[5]  : ##'統一期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future5',StrategyName='Bollinger')
if choice ==choices[6]  : ##'金融期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future6',StrategyName='Bollinger')
if choice ==choices[7]  : ##'小型臺指期: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future7',StrategyName='Bollinger')
if choice ==choices[8]  : ##'臺股期貨: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='future8',StrategyName='Bollinger')
if choice ==choices[9]  : ##'元大台灣50: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='Bollinger')
if choice ==choices[10]  :## '元大台灣50正2: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='Bollinger')
if choice ==choices[11]  : ##'台積電: 2023.4.17 至 2025.4.17':
    OrderRecord.GeneratorProfitChart(choice='stock',StrategyName='Bollinger')
...
OrderRecord.GeneratorProfit_rateChart(StrategyName='RSI')
OrderRecord.GeneratorProfit_rateChart(StrategyName='Bollinger')
